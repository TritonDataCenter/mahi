...
function assumeRole(req, res, next) {
    ...
    function generateTemporaryCredentials(roleData) {
        ...
        accesskey.generate(accesskey.DEFAULT_PREFIX,
             ...
             * parent key actually carried a scope.  Storing null in
             * LDAP is not meaningful and would break filters.
             */
            if (callerBucketScope) {
                ldapObject.accesskeyscope = callerBucketScope;
            }
...
function buildLdapObjectForSessionToken(params) {
    ...
    if (params.bucketScope) {
        obj.accesskeyscope = params.bucketScope;
    }
    return (obj);
}
