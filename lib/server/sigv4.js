...
function createCanonicalRequest(method, uri, queryString, headers,
        ...
        // XXX we send this from manta-buckets-api to match
        ...
        if ('content-length' in headers) {
            headers['content-length'] = headers['edgecast-content-length'];
        }

        if ('content-md5' in headers) {
            headers['content-md5'] = headers['edgecast-content-md5'];
        }
