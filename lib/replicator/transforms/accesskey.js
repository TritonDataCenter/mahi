...
function add(opts, cb) {
    ...
    redis.get(key, function (err, res) {
         ...
         * informational only: the replicator is the sole
         * producer, its changenumbers are monotonic by
         * construction, and no consumer compares them.
         * Compute defensively so the field stays consistent
         * even when changelog entries lack a parseable
         * changenumber.
         */
