...
function add(opts, cb) {
    ...
    redis.get(key, function (err, res) {
        ...
        /*
         * Note: CloudAPI may have already pushed this key to
         * Redis via POST /cache-push for immediate availability.
         * This replicator write is the authoritative fallback
         * and is idempotent — same data format, last-writer-wins.
         */
