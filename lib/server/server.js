...
function getAccountUuid(req, res, next) {
    ...
    req.log.debug({account: account}, 'getAccountUuid: entered');
    lib.getAccountUuid({
        account: account,
        log: req.log,
        redis: req.redis
...
function getAccount(req, res, next) {
    ...
    req.log.debug({uuid: uuid}, 'getAccount: entered');
    lib.getAccount({
        uuid: uuid,
        log: req.log,
        redis: req.redis
...
function getUser(req, res, next) {
    ...
    req.log.debug({uuid: uuid}, 'getUser: entered');
    lib.getUser({
        uuid: uuid,
        log: req.log,
        redis: req.redis
...
function getRoles(req, res, next) {
    ...
    req.log.debug({roles: roles}, 'getRoles: entered');
    lib.getRoles({
        roles: roles,
        log: req.log,
        redis: req.redis
...
function getName(req, res, next) {
    ...
    req.log.debug({uuids: uuids}, 'getName: entered');
