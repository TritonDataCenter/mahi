...
exports.testRoleAssumptionWithSpecificUser = function (t) {
    ...
    setupRoleData(TEST_ROLE_UUID, TEST_ROLE_NAME, TEST_ACCOUNT_UUID,
        ...
        /*
         * Note: assumeRole communicates errors primarily via HTTP status
         * codes (res.send(statusCode)). Early validation errors use
         * next(err), but runtime errors (trust policy failures, role not
         * found, etc.) only set HTTP status. For success cases, checking
         * res.getStatus() is sufficient.
         */
