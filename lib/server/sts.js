...
function assumeRole(req, res, next) {
    ...
    /**
     * @type {string|null} callerBucketScope - Bucket scope
     * inherited from the parent access key. When non-null the
     * temporary credentials are restricted to this bucket.
     */
    var callerBucketScope = caller.bucketScope || null;
    ...
    function generateTemporaryCredentials(roleData) {
        ...
        accesskey.generate(accesskey.DEFAULT_PREFIX,
            ...
            var accessKeyData = {
                ...
                /** @type {string|null} bucket scope from parent key */
