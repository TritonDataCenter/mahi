    ...
    var isTemporaryCredential = sessionToken &&
        ...
        redis.get(accessKeyLookupKey, function (err, lookupVal) {
                ...
                redis.get(userKey, function (userErr, userRes) {
                         ...
                         *
                         * Permanent credentials are stored as
                         * objects with secret and scope fields.
                         * Legacy plain-string format tolerated
                        ...
                        if (keyData &&
                                ...
                                /*
                                 * Legacy format: bare secret
                                 * string.  Tolerate during
                                 * rolling upgrade.
                                 */
                                secretKey = keyData;
                        }
