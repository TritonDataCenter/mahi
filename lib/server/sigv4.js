    ...
    var isTemporaryCredential = sessionToken &&
        ...
        redis.get(accessKeyLookupKey, function (err, userUuid) {
                ...
                redis.get(userKey, function (err, userRes) {
                        ...
                        // Y2038 detection: Log warning for post-Y2038 timestamps.
                        // JavaScript Date arithmetic works correctly on all
                        // platforms, so freshness check proceeds normally.
                        // TODO: This check will be removed once mahi is migrated
                        // to a 64-bit Node.js version, as Y2038 only affects
                        // 32-bit systems. This is a temporary measure.
                        if (requestTime > Y2038_THRESHOLD_MS) {
                                log.warn({
                                        requestTimestamp: timestamp,
                                        requestTimeMs: requestTime,
