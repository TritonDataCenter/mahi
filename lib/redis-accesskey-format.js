 ...
 * in-workspace writer of permanent key data to Redis. This
 * module is the single source of truth for the Redis format
 * so the structure stays stable for the sigv4 reader and any
 * out-of-workspace operator tooling that needs to inspect or
 * write entries.
 *
